...
function inbound_232($array){

	$campaignid = 21218;
	$message = "TelkoKey: Our contact centre is currently closed. Please reply CALL ME between 8am - 8pm or call 1300 975 212. Thank you.";
	$userid = 133;
	$email["to"] = "credit.support@telkokey.com.au";
