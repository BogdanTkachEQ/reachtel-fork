...
function inbound_241($array){

	$campaignid = 24333;
	$message = "Yourtel: Our contact centre is currently closed. Please reply CALL ME between 8am - 8pm or call 1300 456 322 Thank you.";
	$userid = 1066;
	$callmedest = "1300456322";
	$email["to"] = "creditsupport@Yourtel.com.au";
