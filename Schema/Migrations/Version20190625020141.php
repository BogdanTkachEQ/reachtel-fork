 ...
 */
class Version20190625020141 extends AbstractReachtelMigration
{
    /**
     * @param Schema $schema
     */
    ...
    {
        $sql = 'UPDATE sms_api_mapping SET billing_products_region_id = :id WHERE billingtype = :bt';
    ...
    {
        $sql = 'UPDATE sms_api_mapping SET billing_products_region_id = :id';
