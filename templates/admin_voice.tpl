                                ...
                                <div class="main-common-block">
                                	...
                                	<table class="campaignTableCenter common-object-table" width="300px">
                                		<thead>
                                			<tr>
												...
												<th style="width: 50px; text-align: center;">CPS</th>
                                		...
                                		<tbody>
                                			...
                                			<tr>
                                				<td><a href="admin_listvoicesupplier.php?name={$v.name|urlencode}">{$v.name|escape:html|highlight:$search nofilter}</a></td>
                                				<td style="text-align: center;">{$v.maxchannels}</td>
												<td style="text-align: center;">{$v.callspersecond}</td>
                                				...
                                				<td style="width: 50px; text-align: center;"><a href="admin_voice.php?supplierid={$k}&amp;action=delete&amp;csrftoken={$smarty.session.csrftoken|default:''}" onclick="javascript: if(!confirm('Confirm delete?')) {ldelim} return false; {rdelim}"><span class="famfam" style="background-position: -280px -160px;" title="Delete" alt="Delete"></span></a></td>
                                			</tr>
                                			{/foreach}
                                			{else}
                                			<tr>
                                				<td colspan="5">No Voice Suppliers</td>
                                			</tr>
                                			{/if}
                                		</tbody>
                                	</table>
                                	...
                                	<form action="?" method="post" class="common-form">
                                		<fieldset>
                                			...
                                			<div class="inner">
                                				<div class="field">
                                					<label>Technology &amp; Supplier name:</label>
                                					<select class="selectbox" style="width: 100px; text-align: center;" name="type"><option value="IAX2" title="IAX">IAX</option><option value="SIP" title="SIP" selected="selected">SIP</option></select>&nbsp;&nbsp;<input name="name" value="" type="text" class="textbox" maxlength="25" />
