                                ...
                                <div class="main-common-block">
                                	...
                                	<table class="campaignTableCenter common-object-table" width="350px">
                                		<thead>
                                			<tr>
...
{foreach from=$suppliers key=k item=v}
                                			<tr>
                                				<td><a href="admin_listsmssupplier.php?name={$v.name|urlencode}">{$v.name|escape:html|highlight:$search nofilter}</a></td>
                                				<td style="width: 50px; text-align: center;">{$v.priority}</td>
                                				...
                                				<td style="width: 50px; text-align: center;"><a href="admin_sms_suppliers.php?supplierid={$k}&amp;action=delete&amp;csrftoken={$smarty.session.csrftoken|default:''}" onclick="javascript: if(!confirm('Confirm delete?')) {ldelim} return false; {rdelim}"><span class="famfam" style="background-position: -280px -160px;" title="Delete" alt="Delete"></span></a></td>
                                			</tr>
{/foreach}
{else}
                                			<tr>
                                				<td colspan="4">No SMS Suppliers</td>
                                			</tr>
{/if}
                                		</tbody>
                                	</table>
