...
$campaignid = api_campaigns_checknameexists("BaycorpNZ-" . date("Fy", strtotime("yesterday")) . "-CallMe");
...
while(!$rs->EOF){
	...
	if($groupowner[$rs->Fields("campaignid")] == 400){
...
$email["to"]          = api_cron_tags_get(63, "reporting-destination");
$email["subject"]     = "[ReachTEL] BaycorpNZ - Daily CALLME and Handset Delivery report - " . date("Y-m-d", strtotime("yesterday"));
