...
$campaigns = api_campaigns_list_all(false, null, 15, array("search" => "MBFS-IVR-" . $datetime->format('jFy') . "*"));
...
$filename = "MBFS-PHONE-REACHTEL-" . $datetime->format('dmY-His') . ".csv";
...
$tempfname = tempnam("/tmp", "mbfs-ivr");
