...
$rs = api_db_query_read($sql, array(9884, $start, $end));
...
$email["to"]          = api_cron_tags_get(25 , "reporting-destination");
$email["subject"]     = "[ReachTEL] BaycorpWA - Daily CALLME and Handset Delivery report - " . date("Y-m-d", strtotime("yesterday"));
