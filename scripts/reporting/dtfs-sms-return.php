...
foreach(api_campaigns_list_all(true, null, 15, array("search" => "DTFS-SMS-*-SFTP")) as $campaignid => $name){
...
$tempfname = tempnam("/tmp", "dtfs-sms");
...
$filename = "DTFS-SMS-REACHTEL-" . date("dmY-His") . ".csv";
