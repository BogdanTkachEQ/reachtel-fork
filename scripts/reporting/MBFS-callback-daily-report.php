...
// find out which of those are MBFS
$callback_targets = [];
$campaign_ids = [];
...
foreach ($report as &$data) {
	...
	// this logic is shared with MBFS-IVR-daily-report.php and they should be updated together
	$comments = [];
...
$filename = "MBFS-PHONE-CALLBACK-REACHTEL-" . $end_date->format("dmY-His") . ".csv";
...
$tempfname = tempnam("/tmp", "mbfs-callback");
