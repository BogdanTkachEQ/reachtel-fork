...
$filename = "ReachTEL-Email2SMS-" . date("Ymd") . ".csv";

$email["to"]          = api_cron_tags_get(34, "reporting-destination");
$email["subject"]     = "[ReachTEL] Email-2-SMS - Daily report - " . date("d/m/Y", strtotime($start)) . " to " . date("d/m/Y", strtotime($end));
