...
$campaigns = api_campaigns_list_all(false, null, false, array("search" => "DTFS-IVR-*" . $datetime->format('Fy') . "*"));
...
usort($final_report, '_sort_dtfs_campaigns');
...
$filename = "DTFS-PHONE-REACHTEL-MONTHLY-" . $datetime->format('MY') . ".csv";
 ...
 *
 * eg
 * DTFS-IVR-3May19-SFTP
 * DTFS-IVR-3May19-Contact2
 * DTFS-IVR-3May19-Contact3
 * DTFS-IVR-3May19-1-SFTP
 * DTFS-IVR-3May19-1-Contact2
 * DTFS-IVR-3May19-1-Contact3
 * DTFS-IVR-4May19-SFTP
 * DTFS-IVR-4May19-Contact2
 * DTFS-IVR-4May19-Contact3
 *
 * @param array $a
 * @param array $b
 *
 * @return integer
 */
function _sort_dtfs_campaigns(array $a, array $b) {
	// sort dates
