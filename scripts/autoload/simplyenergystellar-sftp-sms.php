...
// This file is a copy of autoload script simplyenergy-sftp-sms.php
// @see REACHTEL-742
...
$base_email = [
	...
	'subject' => '[ReachTEL] Auto-load error - Stellar Simply Energy - ' . $filename,
];
...
$possible_files = [
	'/Simply_Energy_Payment_Extensions_%s/' => 'SimplyEnergy-EXTENSIONSMS-%s',
];
