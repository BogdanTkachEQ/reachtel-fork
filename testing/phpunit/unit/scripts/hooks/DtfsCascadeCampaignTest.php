<?php
/**
 * DtfsCascadeCampaignTest
 * Unit test for script dtfs_cascade_campaign.php
 *
 * @author      karthick.appadurai@equifax.com
 ...
 * DtfsCascadeCampaignTest
 */
class DtfsCascadeCampaignTest extends AbstractPhpunitUnitTest
{
	/**
	...
	public static function setUpBeforeClass() {
		require_once(APP_ROOT_PATH . '/scripts/hooks/dtfs_cascade_campaign.php');
	 ...
	 * @return array
	 */
	public function dtfsCascadeCampaignGetNextCampaignNameDataProvider() {
		return [
			[false, 'Bad Campaign Name'],
			['DTFS-IVR-11Feb2019-Contact2', 'DTFS-IVR-11Feb2019-SFTP'],
			['DTFS-IVR-11Feb2019-Contact3', 'DTFS-IVR-11Feb2019-Contact2'],
			[false, 'DTFS-IVR-11Feb2019-Contact3'],
		];
	}

	/**
	 * @dataProvider dtfsCascadeCampaignGetNextCampaignNameDataProvider
	 * @param string|boolean $expected
	 * @param string         $campaignName
	 * @return void
	 */
	public function testDtfsCascadeCampaignGetNextCampaignName($expected, $campaignName) {
		$this->assertEquals($expected, \_dtfs_cascade_campaign_get_next_campaign_name($campaignName));
	}
	 ...
	 * @return array
	 */
	public function dtfsCascadeCampaignGetNextTargetKeyDataProvider() {
		return [
	...
	/**
	 * @dataProvider dtfsCascadeCampaignGetNextTargetKeyDataProvider
	 * @param string|boolean $expected
	 * @param array          $params
	 * @return void
	 */
	public function testDtfsCascadeCampaignGetNextTargetKey($expected, array $params) {
		$this->assertEquals($expected, \_dtfs_cascade_campaign_get_next_target_key($params['campaign_number'], $params['target_key']));
	}
	 ...
	 * @return array
	 */
	public function dtfsCascadeCampaignGetCampaignNumberDataProvider() {
		return [
			[false, 'Bad Campaign Name'],
			[1, 'DTFS-IVR-11Feb2019-SFTP'],
			[2, 'DTFS-IVR-11Feb2019-Contact2'],
			[3, 'DTFS-IVR-11Feb2019-Contact3'],
		];
	}

	/**
	 * @dataProvider dtfsCascadeCampaignGetCampaignNumberDataProvider
	 * @param string|boolean $expected
	 * @param string         $campaignName
	 * @return void
	 */
	public function testDtfsCascadeCampaignGetCampaignNumber($expected, $campaignName) {
		$this->assertEquals($expected, \_dtfs_cascade_campaign_get_campaign_number($campaignName));
	}
	 ...
	 * @return array
	 */
	public function dtfsCascadeCampaignGetDestinationDataProvider() {
		return [
	...
	/**
	 * @dataProvider dtfsCascadeCampaignGetDestinationDataProvider
	 * @param string|boolean $expected
	 * @param array          $params
	 * @return void
	 */
	public function testDtfsCascadeCampaignGetDestination($expected, array $params) {
		$this->assertEquals($expected, \_dtfs_cascade_campaign_get_destination($params['campaign_number'], $params['merge_data']));
	}
	 ...
	 * @return array
	 */
	public function apiCampaignsHooksDtfsCascadeCampaignDataProvider() {
		$contact_merge_data = [
			'Primary_Contact_Number' => '61400000001',
			'Contact_Number_2' => '61400000002',
			'Contact_Number_3' => '61400000003',
	 ...
	 *
	 * @dataProvider apiCampaignsHooksDtfsCascadeCampaignDataProvider
	 * @param boolean $expected
	 * @param array   $data
	 *
	 * @return void
	 */
	public function testApiCampaignsHooksDtfsCascadeCampaign($expected, array $data) {
		...
		ob_start();
		api_campaigns_hooks_dtfs_cascade_campaign($data['campaign_id']);
	 ...
	 * @return array
	 */
	public function dtfsCascadeCampaignGetWellKnownFieldsDataProvider() {
		$merge_data = [
			'Primary_Contact_Number' => '61400000001',
			'Contact_Number_2' => '61400000002',
			'Contact_Number_3' => '61400000003',
	...
	/**
	 * @dataProvider dtfsCascadeCampaignGetWellKnownFieldsDataProvider
	 * @param string|boolean $expected
	 * @param array          $params
	 * @return void
	 */
	public function testDtfsCascadeCampaignGetWellKnownFields($expected, array $params) {
		$this->assertEquals($expected, \_dtfs_cascade_campaign_get_well_known_fields($params['campaign_number'], $params['merge_data']));
	}
}
