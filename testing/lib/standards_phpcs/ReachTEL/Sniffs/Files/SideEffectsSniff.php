 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class ReachTEL_Sniffs_Files_SideEffectsSniff implements PHP_CodeSniffer_Sniff
{
    /**
     * A list of disabled effects
     *
     * @var array
     */
    public $disabledEffects = [];
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($result['symbol'] !== null && $result['effect'] !== null && !in_array($tokens[$result['effect']]['type'], $this->disabledEffects)) {
