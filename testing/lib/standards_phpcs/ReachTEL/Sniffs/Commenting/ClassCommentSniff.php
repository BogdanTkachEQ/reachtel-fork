 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class ReachTEL_Sniffs_Commenting_ClassCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        foreach ($tokens[$commentStart]['comment_tags'] as $tag) {
        	// ReachTEL hack start for PHPUnit annotations
        	if (in_array($tokens[$tag]['content'], ['@runTestsInSeparateProcesses'])) {
        		continue;
        	}
        	// ReachTEL hack end
